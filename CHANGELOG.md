...
- **Workbench UI Refinement**: Replaced the "dot and text" status indicators with pill badges for PR and Issue states.
- **Table Layout Optimization**: Removed conditional row background colors in the Active Workbench to create a cleaner, unified table design, relying on the new high-visibility badges for state communication.

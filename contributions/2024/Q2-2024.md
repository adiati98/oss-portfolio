...
## Docs fix link in the issue template #271, Updated the code with new updated url
...
## Screenshot (Required for PR Review)
![Screenshot from 2024-05-09 22-14-47](https://github.com/open-sauced/guestbook/assets/145915658/110e7415-b59a-4c9a-a9c8-5da1c2acc2fc)
...
-->
    ...
    <tr>
      ...
      <td>## Description
fix: This PR replaces the old logo of README.md to the new one
...
the problem
![Screenshot 2024-04-30 233601](https://github.com/open-sauced/docs/assets/121073318/1ea904e4-f048-4edd-b67d-e87545f5a354)

the solution
![Screenshot 2024-04-30 233536](https://github.com/open-sauced/docs/assets/121073318/8b370923-0e80-4a45-afbe-e484c55fc0e0)
...
Fixes additional resources related to issue #163.
    ...
    <tr>
      ...
      <td>## Description
Hello,
This pull request has been introduced to remove the existing "pizza-slice" image and use a new one instead, downloaded from the link mentioned in the original issue #158.
If at all you find any issues in this PR or any misunderstanding from my end, then do let me know.
...
<!--
Please do not leave this blank
This PR adds krm-shrftdnv as a contributor.
-->
...
<!-- Please provide a screenshot of your profile being generated on the README. This ensures that you ran the `npm run contributors:generate` command, as mentioned in the previous question, which makes it easier for the maintainers to review PRs. All PRs without screenshots will be automatically rejected-->
![image](https://github.com/open-sauced/guestbook/assets/42980681/19cf2684-d1e8-4973-b82f-4b917e89995a)
...
![Screenshot_1](https://github.com/open-sauced/guestbook/assets/61758061/a54bb28d-33e9-4739-9a50-c88165d6a2b7)
...
![My screenshot](https://github.com/open-sauced/guestbook/assets/160677568/202328f2-5201-444b-bcfa-4035809d5e68)
...
This PR is responsible for adding the section on effective communication and collaboration. 
...
https://github.com/open-sauced/landing-page/assets/105683440/c56fd2ba-e537-41a9-8e28-1cf9c9efb1f9
...
-->
## Note to Reviewers
I used [this tool](https://bloggerpilot.com/en/tools/svg-to-css/) to get the CSS. 
</td>
      <td>2024-04-17</td>
    </tr>
  </tbody>

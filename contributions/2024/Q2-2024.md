...
- Breakdown the instruction of creating an issue in the [Let's Get Practical](https://intro.opensauced.pizza/#/intro-to-oss/how-to-contribute-to-open-source?id=getting-started) section.</td>
    ...
    <tr>
      <td>OpenSource-Communities/intro</td>
      <td><a href='https://github.com/OpenSource-Communities/intro/issues/176'>fix: Add information on the PR process for contributing</a></td>
      <td>## Context
...
1. Complete a PR template
2. Check your work by running it locally
...
Contributors should include a description, learn about [using keywords in a PR](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/using-keywords-in-issues-and-pull-requests), and provide any other necessary information. 

For 2. we should explain where to find the direction for running a project locally and explain why it's important to do that before submitting a PR for review.</td>
      <td>2024-05-11</td>
    </tr>
    <tr>
      <td>OpenSource-Communities/intro</td>

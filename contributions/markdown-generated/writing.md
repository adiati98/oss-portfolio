...
Long-form guides, community essays, and conference talks by **adiati98**, covering insights and tutorials regarding the Open Source and GitHub ecosystem.
...
* **[Beyond Hacktoberfest: Building a True Open Source Journey](https://dev.to/adiatiayu/beyond-hacktoberfest-building-a-true-open-source-journey-3pci)**
  * Published on **Dev.to** — October 27, 2025
...
* **[My First Video Tutorials Contribution for Hacktoberfest](https://dev.to/adiatiayu/my-first-video-tutorials-contribution-for-hacktoberfest-3blg)**
  * Published on **Dev.to** — October 22, 2025
...
* **[Giving non-code contributions the recognition they deserve](https://dev.to/adiatiayu/giving-non-code-contributions-the-recognition-they-deserve-2phj)**
  * Published on **Dev.to** — October 15, 2025

* **[Hacktoberfest: Making it Enjoyable for Contributors and Maintainers](https://dev.to/adiatiayu/hacktoberfest-making-it-enjoyable-for-contributors-and-maintainers-54gk)**
  * Published on **Dev.to** — October 13, 2025
...
* **[How I Built a Curated, Automated Open Source Portfolio](https://dev.to/adiatiayu/how-i-built-a-curated-automated-open-source-portfolio-18o0)**
  * Published on **Dev.to** — October 6, 2025
...
* **[Open Source is For Everyone: First Experience in Non-Code Contribution to Mautic during Hacktoberfest 2024](https://dev.to/adiatiayu/open-source-is-for-everyone-first-experience-in-non-code-contribution-to-mautic-during-4oph)**
  * Published on **Dev.to** — November 19, 2024
...
* **[Hacktoberfest 2024: My 2nd Year Experience as A Maintainer](https://dev.to/adiatiayu/hacktoberfest-2024-my-2nd-year-experience-as-a-maintainer-n7f)**
  * Published on **Dev.to** — November 3, 2024

* **[Hacktoberfest 2024: Why You Should Participate](https://dev.to/virtualcoffee/hacktoberfest-2024-why-you-should-participate-4ffm)**
  * Published on **Dev.to** — September 30, 2024

* **[How to Set Up GitHub CLI on WSL2](https://www.freecodecamp.org/news/github-cli-wsl2-guide/)**
  * Published on **freeCodeCamp** — August 14, 2024
...
* **[From Contributor to Maintainer: My Journey in Open Source](https://dev.to/adiatiayu/from-contributor-to-maintainer-my-journey-in-open-source-1lif)**
  * Published on **Dev.to** — May 21, 2024
...
* **[Streamline Your Contributions: Mastering Issue Forms and PR Templates](https://dev.to/opensauced/streamline-your-contributions-mastering-issue-forms-and-pr-templates-36j5)**
  * Published on **Dev.to** — May 9, 2024
...
* **[Building Bridges, Not Walls: The Importance of Documentation in Open Source Projects](https://dev.to/opensauced/building-bridges-not-walls-the-importance-of-documentation-in-open-source-projects-oaj)**
  * Published on **Dev.to** — April 30, 2024

* **[The Secret Recipe to Getting Your Pull Requests Reviewed (and Merged) Faster](https://dev.to/opensauced/the-secret-recipe-to-getting-your-pull-requests-reviewed-and-merged-faster-1fag)**
  * Published on **Dev.to** — April 23, 2024
...
* **[The Missing Piece: Why Your Project Needs a Maintainer Onboarding Process](https://dev.to/opensauced/the-missing-piece-why-your-project-needs-a-maintainer-onboarding-process-np0)**
  * Published on **Dev.to** — April 18, 2024
...
* **[How to Resolve Merge Conflicts Using the Merge Editor Feature on VS Code](https://dev.to/adiatiayu/how-to-resolve-merge-conflicts-using-the-merge-editor-feature-on-vs-code-pic)**
  * Published on **Dev.to** — November 22, 2023
...
* **[How to Keep Branches Up-to-Date and Resolve Merge Conflicts in GitHub and VS Code](https://www.freecodecamp.org/news/keep-branches-up-to-date-resolve-merge-conflicts/)**
  * Published on **freeCodeCamp** — November 22, 2023
...
* **[Building Your Brand as a Developer Through Open Source](https://dev.to/adiatiayu/building-your-brand-as-a-developer-through-open-source-djl)**
  * Published on **Dev.to** — November 21, 2023
...
* **[How Important is a Code of Conduct in an Open-Source Project?](https://dev.to/adiatiayu/how-important-is-a-code-of-conduct-in-an-open-source-project-507j)**
  * Published on **Dev.to** — September 26, 2023
...
* **[How to Contribute to Open-Source Projects – Git & GitHub Workflow for Beginners](https://www.freecodecamp.org/news/git-and-github-workflow-for-open-source/)**
  * Published on **freeCodeCamp** — September 22, 2023
...
* **[How to Contribute to Open Source Projects – Non-Technical Things You Should Know](https://www.freecodecamp.org/news/how-to-contribute-to-open-source/)**
  * Published on **freeCodeCamp** — September 14, 2023

* **[#100DaysOfOSS Recap: Day 28-50](https://dev.to/adiatiayu/100daysofoss-recap-day-28-50-l8h)**
  * Published on **Dev.to** — September 11, 2023

* **[Open Source and Git Glossary](https://dev.to/adiatiayu/open-source-and-git-glossary-mn2)**
  * Published on **Dev.to** — August 30, 2023

* **[#100DaysOfOSS Recap: Day 15-27](https://dev.to/adiatiayu/100daysofoss-recap-day-15-27-360h)**
  * Published on **Dev.to** — August 19, 2023

* **[How to Communicate Better in Open Source](https://dev.to/adiatiayu/how-to-communicate-better-in-open-source-3hdj)**
  * Published on **Dev.to** — August 14, 2023

* **[#100DaysOfOSS Recap: Day 1-14](https://dev.to/adiatiayu/100daysofoss-recap-day-1-14-3f0j)**
  * Published on **Dev.to** — August 7, 2023

* **[Mini Portfolio: Bring Your GitHub Profile To The Next Level](https://dev.to/adiatiayu/mini-portfolio-bring-your-github-profile-to-the-next-level-5c8n)**
  * Published on **Dev.to** — September 12, 2022

* **[How To Use GitHub For Project Collaboration — Based on Agile Method](https://dev.to/adiatiayu/how-to-use-github-for-project-collaboration-based-on-agile-method-kb7)**
  * Published on **Dev.to** — March 5, 2022

* **[How to fetch a contribution branch to test it locally as an open-source maintainer](https://dev.to/adiatiayu/how-to-fetch-a-contribution-branch-to-test-it-locally-as-an-open-source-maintainer-hgf)**
  * Published on **Dev.to** — February 24, 2022

* **[Git: How to fetch a branch from the upstream to the local repo in 5 steps](https://dev.to/adiatiayu/git-how-to-pull-a-branch-from-the-upstream-to-the-local-repo-in-5-steps-1ili)**
  * Published on **Dev.to** — February 14, 2022

* **[What I Learned From Hacktoberfest 2021](https://dev.to/adiatiayu/what-i-learned-from-hacktoberfest-2021-8ol)**
  * Published on **Dev.to** — November 2, 2021

* **[Contributing To Open-Source 101](https://dev.to/adiatiayu/contributing-to-open-source-101-2dnm)**
  * Published on **Dev.to** — October 29, 2021

* **[First Week of The Hacktoberfest: 8 Top Questions Around Git](https://dev.to/adiatiayu/first-week-of-the-hacktoberfest-8-top-questions-around-git-5g70)**
  * Published on **Dev.to** — October 13, 2021

* **[How To Make Changes On A Commit In A Pull Request Directly On GitHub's Website](https://dev.to/adiatiayu/how-to-make-changes-on-a-commit-in-a-pull-request-directly-on-github-s-website-30cd)**
  * Published on **Dev.to** — September 27, 2021

* **[Why Ethics In Contributing To Open-Source Matters](https://dev.to/adiatiayu/contributing-ethics-in-open-source-5eem)**
  * Published on **Dev.to** — September 20, 2021

* **[Contributing To An Open Source by A First-Timer (Part 2)](https://dev.to/adiatiayu/contributing-to-an-open-source-by-a-first-timer-part-2-20a0)**
  * Published on **Dev.to** — November 21, 2020

* **[Contributing To An Open Source by A First-Timer (Part 1)](https://dev.to/adiatiayu/contributing-to-an-open-source-by-a-first-timer-part-1-2opa)**
  * Published on **Dev.to** — November 21, 2020

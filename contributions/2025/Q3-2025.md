...
1. `mautic/mautic-community-handbook` (62 contributions)
2. `OpenSource-Communities/guestbook` (26 contributions)
3. `Virtual-Coffee/virtualcoffee.io` (7 contributions)
